...
int logicalNeg(int x) {
  int INT32_MAX = ~(1<<31);
  int INT32_MIN = 1<<31;
  return (((~(x + INT32_MAX)>>31)&1) & ((x + INT32_MIN)>>31)&1);
}
 ...
 *   Rating: 4
 */
// I should read the problem carefully, x is integer, not float. The answer need power(2.0,x), returning an IEEE format 32 bits; 
